...
SurfacePtr C3D20::surface(ID surface_id) {
    switch (surface_id) {
        case 1:
            return std::make_shared<Surface8>(std::array<ID, 8> {node_ids[0],
                                                                 ...
                                                                 node_ids[11]});
        case 2:
            return std::make_shared<Surface8>(std::array<ID, 8> {node_ids[4],
                                                                 node_ids[5],
                                                                 node_ids[6],
                                                                 node_ids[7],
                                                                 node_ids[12],
        ...
        case 5:
            return std::make_shared<Surface8>(std::array<ID, 8> {node_ids[2],
                                                                 ...
                                                                 node_ids[18]});
        case 6:
            return std::make_shared<Surface8>(std::array<ID, 8> {node_ids[3],
                                                                 node_ids[0],
                                                                 node_ids[4],
                                                                 node_ids[7],
                                                                 node_ids[11],
